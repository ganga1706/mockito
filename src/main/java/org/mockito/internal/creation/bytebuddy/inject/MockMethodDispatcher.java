...
public abstract class MockMethodDispatcher {
    ...
    public static void handleConstruction(String identifier, Class<?> type, Object object) {
        DISPATCHERS.get(identifier).handleConstruction(type, object);
    }
    ...
    public abstract void handleConstruction(Class<?> type, Object object);
